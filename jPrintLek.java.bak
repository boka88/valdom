...
public class jPrintLek {
	...
	public jPrintLek(Connection _connection){
		connection = _connection;

		nadjiPreduzece();
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/listlek.jrxml");
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM tmplek ORDER BY brojdana";
		try {
