...
public class jPrintVozila {
	...
	public jPrintVozila(Connection _connection){
		...
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/spisakvozila.jrxml");
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM vozila ORDER BY vrstavozila";
		try {
