...
public class mPregledRNIme extends JInternalFrame implements InternalFrameListener
			{
...
//------------------------------------------------------------------------------------------------------------------
    public mPregledRNIme() {
		super("", true, true, true, true);
        setTitle("Pregled radnih naloga po imenu    F9-\u0160ifarnici");
...
//-------------------------------------------------------------------------
   public void kreirajTabelu(){
		...
		izvrsi(strsql);
 		strsql = "INSERT INTO tmprnal(rbr,brsasije,datum) " +
			"SELECT rbr,brsasije,datum FROM rnal";                           
		izvrsi(strsql);
 		strsql = "UPDATE tmprnal,vozila SET tmprnal.ime=vozila.ime," +  
			"tmprnal.regbroj=vozila.regbroj,tmprnal.marka=vozila.marka," +
			"tmprnal.tip=vozila.tip WHERE tmprnal.brsasije=vozila.brsasije";
		izvrsi(strsql);
...
//------------------------------------------------------------------------------------------------------------------
    public void buildTable() {
		...
		sql = "SELECT * FROM tmprnal ORDER BY rbr DESC";
	   	qtbl.query(sql);
		...
		jspane.setBounds(20,400,620,150);
	}
//------------------------------------------------------------------------------------------------------------------
...
//===========================================================================
 class QTMPregledRNal extends AbstractTableModel {
	Connection dbconn;
	String[] colheads = {"Nalog","Datum","Ime ili naziv","Br.registracije","Marka",
						"Tip"};
//------------------------------------------------------------------------------------------------------------------
