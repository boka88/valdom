...
public class jPrintMarka {
	...
	public jPrintMarka(Connection _connection,String _oddat,String _dodat,String _marka){
		...
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/marka.jrxml");
			JasperReport jasperReport = JasperManager.compileReport(jasperDesign);
			
		
			Map parameters = new HashMap();
			//dodavanje eksternih varijabli u report*********************
			parameters.put("oddatuma", oddat);
			parameters.put("dodatuma", dodat);
			parameters.put("markavozila", markavozila);
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM tmpmarka ";
		try {
