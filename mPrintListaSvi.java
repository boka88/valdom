...
public class mPrintListaSvi {
  ...
  public mPrintListaSvi(Connection _connection,
						String _oddat,
						String _dodat) {
...
//------------------------------------------------------------------------------------------
 private void writeDetails() {
        ...
        try {
			...
			output.write("              <fo:block>" + konvUnicode("Lista radnih naloga - svi radnici") + "\n"); 
			output.write("              </fo:block>\n"); 
			output.write("            </fo:table-cell>\n"); 
			// strana -----------------------------------------------------------------------
			output.write("          </fo:table-row>\n"); 
...
//---------------------------------------------------------------------------------
 private void popuniPodatkeIzBaze() {
	...
	String sql = "SELECT rbr,brsasije,datum,ROUND(cenarada,2),ROUND(cenadelova,2),ROUND(zarada,2) " +
     ...
     try {
        ...
        while ( rs.next() ) {
			  ...
			  String[] record = new String[6];
				...
				record[5] = rs.getString("ROUND(zarada,2)");
