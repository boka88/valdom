...
public class jPrintListaR {
	...
	public jPrintListaR(Connection _connection,String _oddat,String _dodat,String _brsasije,String _regbroj){
		...
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/spisakrn.jrxml");
			...
			parameters.put("brsasije", brsasije);
			parameters.put("regbroj", regbroj);
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM rnal WHERE brsasije='" + brsasije + "'";
		try {
