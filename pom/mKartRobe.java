 ...
 public void Obrada() {
	...
	strsql = "CREATE TEMPORARY TABLE tmpkarticarobe (" +
	  ...
	  " kolicme  double default '0'" +
		...
		strsql = "INSERT INTO tmpkarticarobe(konto,sifm,oznaka,jur,mag,ui,vrdok,brdok,datum,kolic," +
...
//------------------------------------------------------------------------------------------------------------------
    public void Stampa() {
		...
		/*
		mPrintKartRobe jjj = new mPrintKartRobe(connection,odjur,dojur,
												odmag,domag,
												konto,sifra,
												koji,nazkonta,
												nazrobe);
...
//===========================================================================
 class QTMKartProm extends AbstractTableModel {
	...
	String[] colheads = {"Ozn","Opis","RJ","Mag.","Vrs.dok.",
						...
						"Vrednost","Br.unosa","Br.stavke","Saradnik","Ra\u010dun","Saldo kol."};
        ...
        statement = dbconn.createStatement();
            ...
            while ( rs.next() ) {
               ...
               Object[] record = new Object[15];
				...
				record[14] = myFormatter.format(saldokol);
