...
public class jPrintOprema {
	...
	public jPrintOprema(Connection _connection, String _brsasije){
		...
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/oprema.jrxml");
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM oprema where brsasije='" + brsasije + 
			"' ORDER BY rbr";
		try {
