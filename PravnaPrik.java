...
public class PravnaPrik extends JDialog{
   ...
   public PravnaPrik(int kojaf)	{
		...
		JLabel lnazkorisnici = new JLabel("Naziv - tra\u017ei: ");
		...
		this.setTitle("\u0160ifarnik pravnih lica");
   ...
   public void Kreni() {
		...
		switch(kojaForma){
			case 1:
				...
				aVozila.displej.setText(kojeIme);
				break;
			case 2:
				break;
		}
...
//--------------------------------------------------------------------------------------
    public void proveriPoNazivu(){
	      if ( !nazkorisnici.getText().equals( "" )) { 
	            String sql = "SELECT * FROM pravna WHERE naziv " +
...
//=======================================================================================
 class QueryTableModel2 extends AbstractTableModel {
   ...
   String[] colheads = {"Maticni br.","Naziv","Delatnost","Ulica","Broj"};
