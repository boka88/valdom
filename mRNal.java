...
//------------------------------------------------------------------------------------------------------------------
    public JPanel buildPanel() {
		...
		jspane1.setBounds(prviTX,aa + 3*(visina + razmakY) + 30,500,70);
		...
		jspane2.setBounds(prviTX,aa + 4*(visina + razmakY) + 85,500,70);
		...
		jspane4.setBounds(prviTX,aa + 7*(visina + razmakY) + 180,500,45);
