...
public class jPrintRadnici {
	...
	public jPrintRadnici(Connection _connection){
		connection = _connection;

		nadjiPreduzece();
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/radnici.jrxml");
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM radnici ORDER BY imeprezime";
		try {
