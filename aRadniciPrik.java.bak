...
public class aRadniciPrik extends JDialog{
   ...
   public aRadniciPrik(int kojaf)	{

		Container cont = getContentPane();
		cont.setLayout(new BorderLayout());
		setTitle("Radnici-operateri");
...
//--------------------------------------------------------------------------------------
   public void Kreni() {
		...
		switch(kojaForma){
			case 1:
				aUnosKvarova.sifRadnika.setText(kojiKonto);
				aUnosKvarova.lblRadnikPrik.setText(kojiNazKonta);
				break;
			case 2:
...
//--------------------------------------------------------------------------------------
  public void proveriPoNazivu(){
			if ( !naziv.getText().equals( "" )) {
	            String sql = "SELECT * FROM operateri WHERE nazivm" +
...
//=======================================================================================
 class mQTmProdavPrik extends AbstractTableModel {
   Connection dbconn;
	String[] colheads = {"\u0160ifra","Ime i prezime","Radno mesto"};
