...
//--------------------------------------------------------------------------------
 private void popuniPodatkeIzBaze() {
	//uzimanje podataka---------------------------------------------------
    String sql = "SELECT * FROM vozila ORDER BY brsasije";
         ...
         Statement statement = connection.createStatement();
            ...
            while ( rs.next() ) {
               ...
               String[] record = new String[6];
				...
				record[5] = rs.getString("godproizvodnje");
			//prikaz podataka----------------------
		  try {
			output.write("          <fo:table-row>\n"); 
			output.write("            <fo:table-cell border-style=\"solid\" border-width=\"0.5pt\">\n"); 
			...
			output.write("            </fo:table-cell>\n"); 
			output.write("            <fo:table-cell border-style=\"solid\" border-width=\"0.5pt\">\n"); 
			output.write("              <fo:block text-align=\"left\">" + konvUnicode(record[2]) + "\n"); 
			output.write("              </fo:block>\n"); 
			output.write("            </fo:table-cell>\n"); 
			output.write("            <fo:table-cell border-style=\"solid\" border-width=\"0.5pt\">\n"); 
