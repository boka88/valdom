...
public class jPrintVozilaPoj {
	...
	private String strdatum="",strvaluta="",strdatump="",oddat,dodat,koji="";
	...
	public jPrintVozilaPoj(Connection _connection,String _koji){
		...
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/vozilo.jrxml");
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM vozila WHERE brsasije='" + koji + "'";
		try {
