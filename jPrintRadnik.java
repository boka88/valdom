...
public class jPrintRadnik {
	...
	public jPrintRadnik(Connection _connection,String _radnik){
		...
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/radnik.jrxml");
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM radnici WHERE jmbg='" + radnik + "'";
		try {
