...
public class jPrintKart {

	public Connection connection = null;
	private String fileName = null,nazivpre="",mestopre="",pPre="",sql,nazrobe;
	private int odmes=0,domes=0,pred,koji;
	private int odrj,dorj,odmag,domag,konto,sifra;
	private String radjed="",magacin="",nazivjur="",nazivmag="",nazkonta;
	private String kolul="",koliz="",stanjekol="",vrul="",vriz="",stanje="",prc="";

	public jPrintKart(Connection _connection,
						int _odrj,
						int _dorj,
						int _odmag,
						int _domag,
		...
		try
		{
			...
			jasperDesign = JasperManager.loadXmlDesign("print/kartrobe.jrxml");
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map<String, String> _parameters){
		...
		String sql = "SELECT * FROM tmpkarticarobe ORDER BY datum";
