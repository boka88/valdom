...
public class jPrintZam {
	...
	public jPrintZam(Connection _connection){
		connection = _connection;

		nadjiPreduzece();
		try
		{
			JasperDesign jasperDesign = JasperManager.loadXmlDesign("print/listzam.jrxml");
...
//--------------------------------------------------------------------------------------
	private JasperPrint uzmiPodatke(JasperReport _jasperReport,Map _parameters){
		...
		String sql = "SELECT * FROM tmpzam ORDER BY brojkm";
		try {
