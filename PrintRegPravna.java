...
public class PrintRegPravna {
  ...
  public PrintRegPravna(String _jmbg, String _regbroj, String _razl) {
...
//------------------------------------------------------------------------------------------
 private void prazanRed3() {
        ...
        try {
				...
				//prazan red ===============================
			output.write("<fo:block text-align=\"center\" space-before.optimum=\"4pt\" space-after.optimum=\"12pt\">"
							+ " " + "\n");
			output.write("              </fo:block>"); 
				//==========================================
		}
...
//------------------------------------------------------------------------------------------
 private void prazanRedM() {
        ...
        try {
				...
				//prazan red ===============================
			output.write("<fo:block text-align=\"center\" space-before.optimum=\"4pt\" space-after.optimum=\"4pt\">"
							+ " " + "\n");
			output.write("              </fo:block>"); 
				//==========================================
		}
	...
	public void popuniImaoca() {
      ...
      try {
         Statement statement = connection.createStatement();
			...
			String query = "SELECT * FROM pravna WHERE matbr='" + JMBG + "'";

		         ResultSet rs = statement.executeQuery( query );
		         if(rs.next()){
		         	rec[0]= rs.getString("matbr");
		         	rec[1]= rs.getString("naziv");
		         	rec[2]= rs.getString("delatnost");
		         	rec[3]= rs.getString("ulica");
		         	rec[4]= rs.getString("broj");
		         	rec[5]= rs.getString("mesto");
		         	rec[6]= rs.getString("opstina");
		         	rec[7]= rs.getString("telefon");
		         	rec[8]= rs.getString("mobilni");
		         	rec[9]= rs.getString("lice");

		  try {
			//treca strana======================================================================
			//naziv org.----------------
			pocetakStrane();
			output.write("<fo:block text-align=\"center\" space-before.optimum=\"20pt\" space-after.optimum=\"25pt\" >"
							+ " " + "\n");
			output.write("              </fo:block>"); 
         ...
         Statement statement = connection.createStatement();
            ...
            ResultSet rs = statement.executeQuery( sql );
		       if(rs.next()){
		         	...
		         	record[18] = rs.getString("obliknamena");
		  ...
		  try {
			  //prva strana---------------------------------------------------
			//registarska oznaka----------------
			output.write("<fo:block text-align=\"center\" space-before.optimum=\"100pt\" space-after.optimum=\"100pt\">"
							+ " " + "\n");
			output.write("              </fo:block>"); 
			output.write("      <fo:table border-width=\"0pt\" table-layout=\"fixed\" font-size=\"12pt\" >\n");
			output.write("	<fo:table-column column-width=\"8cm\"/>\n");
